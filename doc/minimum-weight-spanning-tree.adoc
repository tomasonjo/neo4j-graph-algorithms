...
.Running minimum algorithm and writing back results 
[source,cypher]
----
...
.Running maximum algorithm and writing back results 
[source,cypher]
----
...
.Running k-minimum algorithm and writing back results 
[source,cypher]
----
...
.Running k-maximum algorithm and writing back results 
[source,cypher]
----
...
[source,cypher]
----
CALL algo.spanningTree(label:String, relationshipType:String, weightProperty:String, startNodeId:long, k:int, {writeProperty:String}) 
YIELD loadMillis, computeMillis, writeMillis, effectiveNodeCount
----
