...
* Betweenness centrality is used to identify key players in legitimate or criminal organizations. Studies show that key players in organizations are not necessarily in chief positions but instead can be found in brokerage positions of the organizational network. Removal of such key players could seriously cripple the organization. More detail can be found in http://archives.cerium.ca/IMG/pdf/Morselli_and_Roy_2008_.pdf[Brokerage qualifications in ringing operations] by Carlo Morselli and Julie Roy
