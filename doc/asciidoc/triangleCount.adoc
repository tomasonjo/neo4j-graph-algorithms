...
* Clustering coefficient has been proposed to explore thematic structure of web pages and detect communities of pages with a common topic based of the network of links between pages. Find more in http://www.pnas.org/content/99/9/5825[Curvature of co-links uncovers hidden thematic layers in the World Wide Web]
