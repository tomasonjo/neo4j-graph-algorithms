...
The co-occurence criteria for this network is that any pair of businesses must have common reviewers. 
We save the number of common reviewers as a property of the relationship, that will be used as a weight in community detection analysis.
...
parking attributes of businesses?
