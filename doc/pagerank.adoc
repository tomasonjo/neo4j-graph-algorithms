...
We do not have to save the relationship, we can project it using *cypher loading*.
We load all relationships and then use `UNION` to load all relationships with reversed directions.
